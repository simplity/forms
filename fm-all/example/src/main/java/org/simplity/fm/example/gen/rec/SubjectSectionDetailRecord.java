...
public class SubjectSectionDetailRecord extends DbRecord {
	...
	private static final Dba DBA = new Dba(FIELDS, "subject_section_details", OPERS, SELECT, SELECT_IDX,INSERT, INSERT_IDX, UPDATE, UPDATE_IDX, DELETE, WHERE, WHERE_IDX);
