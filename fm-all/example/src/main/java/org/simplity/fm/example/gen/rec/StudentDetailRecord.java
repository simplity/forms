...
public class StudentDetailRecord extends DbRecord {
	private static final Field[] FIELDS = {
			...
			new DbField("departmentId", 2, DefinedDataTypes.id, null, null, null, "department_id", FieldType.RequiredData), 
	...
	private static final Dba DBA = new Dba(FIELDS, "student_details", OPERS, SELECT, SELECT_IDX,INSERT, INSERT_IDX, UPDATE, UPDATE_IDX, DELETE, WHERE, WHERE_IDX);
