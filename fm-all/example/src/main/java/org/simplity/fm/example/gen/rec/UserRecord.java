...
public class UserRecord extends DbRecord {
	private static final Field[] FIELDS = {
			new DbField("userId", 0, DefinedDataTypes.flexibleId, false, null,
			...
			new DbField("trustId", 2, DefinedDataTypes.id, false, null, null,
					null, "trust_id", FieldType.OptionalData),
			new DbField("userType", 3, DefinedDataTypes.userType, false,
					"Student", null, "userType", "user_type",
					FieldType.OptionalData),
			new DbField("loginId", 4, DefinedDataTypes.loginId, false, null,
					null, null, "login_id", FieldType.OptionalData),
			new DbField("password", 5, DefinedDataTypes.text, false, null, null,
					null, "password", FieldType.OptionalData),
			new DbField("loginEnabled", 6, DefinedDataTypes.bool, false,
					"false", null, null, "login_enabled",
					FieldType.OptionalData),
			new DbField("previousLoginAt", 7, DefinedDataTypes.timestamp, false,
					null, null, null, "previous_login_at",
					FieldType.OptionalData),
			new DbField("currentLoginAt", 8, DefinedDataTypes.timestamp, false,
					null, null, null, "current_login_at",
					FieldType.OptionalData),
			new DbField("resetPasswordCount", 9, DefinedDataTypes.integer,
					false, null, null, null, "reset_password_count",
					FieldType.OptionalData),
			new DbField("resetPasswordSentAt", 10, DefinedDataTypes.timestamp,
					false, null, null, null, "reset_password_sent_at",
					FieldType.OptionalData),
			new DbField("currentLoginIp", 11, DefinedDataTypes.ip, false, null,
					null, null, "current_login_ip", FieldType.OptionalData),
			new DbField("previousLoginIp", 12, DefinedDataTypes.ip, false, null,
					null, null, "previous_login_ip", FieldType.OptionalData),
			new DbField("loginCount", 13, DefinedDataTypes.integer, false, null,
					null, null, "login_count", FieldType.OptionalData),
			new DbField("confirmationToken", 14, DefinedDataTypes.text, false,
					null, null, null, "confirmation_token",
					FieldType.OptionalData),
			new DbField("loginToken", 15, DefinedDataTypes.text, false, null,
					null, null, "login_token", FieldType.OptionalData),
			new DbField("createdAt", 16, DefinedDataTypes.timestamp, false,
					null, null, null, "created_at", FieldType.OptionalData),
			new DbField("createdBy", 17, DefinedDataTypes.id, false, null, null,
					null, "created_by", FieldType.OptionalData),
			new DbField("updatedAt", 18, DefinedDataTypes.timestamp, false,
					null, null, null, "updated_at", FieldType.OptionalData),
			new DbField("updatedBy", 19, DefinedDataTypes.id, false, null, null,
	...
	public List<UserRecord> parseTable(final IInputObject inputObject,
