...
public class DefinedValueSchemas implements IValueSchemas {
	...
	public static final ValueSchema[] allSchemas = {bool, grade, date, country, flexibleId, id, integer, income, marks, tenantKey, valuationType, accountStatus, code, desc, email, gender, govtCode, ip, json, loginId, marksOrAb, name, phone, pin, state, text, uniqueId, url, userType, timestamp};
