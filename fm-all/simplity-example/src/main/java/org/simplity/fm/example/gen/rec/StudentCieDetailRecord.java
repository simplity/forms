...
public class StudentCieDetailRecord extends DbRecord {
	private static final Field[] FIELDS = {
			...
			new DbField("subjectSectionId", 1, DefinedDataTypes.id, false, null,
					null, null, "subject_section_id", FieldType.RequiredData),
			new DbField("departmentName", 2, DefinedDataTypes.text, false, null,
					null, null, "department_name", FieldType.RequiredData),
			new DbField("usn", 3, DefinedDataTypes.text, false, null, null,
					null, "usn", FieldType.OptionalData),
			new DbField("name", 4, DefinedDataTypes.name, false, null, null,
					null, "student_name", FieldType.RequiredData),
			new DbField("eligibility", 5, DefinedDataTypes.name, false, null,
					null, null, "is_eligible", FieldType.OptionalData),
			new DbField("test1", 6, DefinedDataTypes.text, false, "1", null,
					null, null, FieldType.OptionalData),
			new DbField("test2", 7, DefinedDataTypes.text, false, "1", null,
					null, null, FieldType.OptionalData),
			new DbField("test3", 8, DefinedDataTypes.text, false, "1", null,
					null, null, FieldType.OptionalData),
			new DbField("quiz1", 9, DefinedDataTypes.text, false, "1", null,
					null, null, FieldType.OptionalData),
			new DbField("quiz2", 10, DefinedDataTypes.text, false, "1", null,
					null, null, FieldType.OptionalData),
			new DbField("theoryCie", 11, DefinedDataTypes.text, false, "1",
					null, null, null, FieldType.OptionalData),
			new DbField("theoryClassesHeld", 12, DefinedDataTypes.text, false,
					"1", null, null, null, FieldType.OptionalData),
			new DbField("theoryClassesAttended", 13, DefinedDataTypes.text,
					false, "1", null, null, null, FieldType.OptionalData),
			new DbField("theoryClassesPercentage", 14, DefinedDataTypes.text,
					false, "1", null, null, null, FieldType.OptionalData),
			new DbField("practicalCie", 15, DefinedDataTypes.text, false, "1",
					null, null, null, FieldType.OptionalData),
			new DbField("practicalClassesHeld", 16, DefinedDataTypes.text,
					false, "1", null, null, null, FieldType.OptionalData),
			new DbField("practicalClassesAttended", 17, DefinedDataTypes.text,
					false, "1", null, null, null, FieldType.OptionalData),
			new DbField("practicalClassesPercentage", 18, DefinedDataTypes.text,
					false, "1", null, null, null, FieldType.OptionalData),
			new DbField("selfStudy", 19, DefinedDataTypes.text, false, "1",
					null, null, null, FieldType.OptionalData),
			new DbField("practicalMarks", 20, DefinedDataTypes.text, false, "1",
					null, null, null, FieldType.OptionalData),
			new DbField("totalCie", 21, DefinedDataTypes.text, false, "1", null,
					null, null, FieldType.OptionalData)};
