...
public class StudentCieDetailRecord extends DbRecord {
	private static final Field[] FIELDS = {
			...
			new DbField("subjectSectionId", 1, DefinedValueSchemas.id, false, null,
					null, null, "subject_section_id", FieldType.RequiredData),
			new DbField("departmentName", 2, DefinedValueSchemas.text, false, null,
					null, null, "department_name", FieldType.RequiredData),
			new DbField("usn", 3, DefinedValueSchemas.text, false, null, null,
					null, "usn", FieldType.OptionalData),
			new DbField("name", 4, DefinedValueSchemas.name, false, null, null,
					null, "student_name", FieldType.RequiredData),
			new DbField("eligibility", 5, DefinedValueSchemas.name, false, null,
					null, null, "is_eligible", FieldType.OptionalData),
			new DbField("test1", 6, DefinedValueSchemas.text, false, "1", null,
					null, null, FieldType.OptionalData),
			new DbField("test2", 7, DefinedValueSchemas.text, false, "1", null,
					null, null, FieldType.OptionalData),
			new DbField("test3", 8, DefinedValueSchemas.text, false, "1", null,
					null, null, FieldType.OptionalData),
			new DbField("quiz1", 9, DefinedValueSchemas.text, false, "1", null,
					null, null, FieldType.OptionalData),
			new DbField("quiz2", 10, DefinedValueSchemas.text, false, "1", null,
					null, null, FieldType.OptionalData),
			new DbField("theoryCie", 11, DefinedValueSchemas.text, false, "1",
					null, null, null, FieldType.OptionalData),
			new DbField("theoryClassesHeld", 12, DefinedValueSchemas.text, false,
					"1", null, null, null, FieldType.OptionalData),
			new DbField("theoryClassesAttended", 13, DefinedValueSchemas.text,
					false, "1", null, null, null, FieldType.OptionalData),
			new DbField("theoryClassesPercentage", 14, DefinedValueSchemas.text,
					false, "1", null, null, null, FieldType.OptionalData),
			new DbField("practicalCie", 15, DefinedValueSchemas.text, false, "1",
					null, null, null, FieldType.OptionalData),
			new DbField("practicalClassesHeld", 16, DefinedValueSchemas.text,
					false, "1", null, null, null, FieldType.OptionalData),
			new DbField("practicalClassesAttended", 17, DefinedValueSchemas.text,
					false, "1", null, null, null, FieldType.OptionalData),
			new DbField("practicalClassesPercentage", 18, DefinedValueSchemas.text,
					false, "1", null, null, null, FieldType.OptionalData),
			new DbField("selfStudy", 19, DefinedValueSchemas.text, false, "1",
					null, null, null, FieldType.OptionalData),
			new DbField("practicalMarks", 20, DefinedValueSchemas.text, false, "1",
					null, null, null, FieldType.OptionalData),
			new DbField("totalCie", 21, DefinedValueSchemas.text, false, "1", null,
					null, null, FieldType.OptionalData)};
	...
	private static final RecordMetaData META = new RecordMetaData(
			"studentCieDetail", FIELDS, VALIDS);
	/* DB related */
	...
	private static final Dba DBA = new Dba(FIELDS, "student_cie_details", OPERS,
	...
	public List<StudentCieDetailRecord> parseTable(
			final IInputData inputObject, String memberName,
			final boolean forInsert, final IServiceContext ctx) {
		return (List<StudentCieDetailRecord>) super.parseTable(inputObject,
	 ...
	 *
	 * @param value
	 *            to be assigned to theoryClassesHeld
	 */
	 ...
	 *
	 * @param value
	 *            to be assigned to theoryClassesAttended
	 */
	 ...
	 *
	 * @param value
	 *            to be assigned to theoryClassesPercentage
	 */
	 ...
	 *
	 * @param value
	 *            to be assigned to practicalCie
	 */
	 ...
	 *
	 * @param value
	 *            to be assigned to practicalClassesHeld
	 */
	 ...
	 *
	 * @param value
	 *            to be assigned to practicalClassesAttended
	 */
	 ...
	 *
	 * @param value
	 *            to be assigned to practicalClassesPercentage
	 */
	 ...
	 *
	 * @param value
	 *            to be assigned to practicalMarks
	 */
